...
using BelzonaMobile.Droid.Services;
using BelzonaMobile.Core.Models;
using Octane.Xam.VideoPlayer.Android;

namespace BelzonaMobile.Droid
{
	[Activity(Label = "BelzonaMobile", Icon = "@drawable/icon", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
